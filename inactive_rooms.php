...
<div class="d-flex justify-content-between align-items-center mt-0">
    ...
    <button class="top-btn" onclick="window.location.href='rooms.php'">← Back to Active Rooms</button>
...
<div style="margin-top:10px; font-weight:bold; color:#5A7D7C;">
    <a href="rooms.php" style="text-decoration:none; color:#5A7D7C;">Total Active Rooms: <?= $totalActive; ?></a>
</div>
...
<ul class="nav nav-tabs mb-3" id="roomTabs">
  <li class="nav-item">
    <a class="nav-link" href="rooms.php">Active Rooms</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="inactive_rooms.php">Inactive Rooms</a>
  </li>
</ul>
