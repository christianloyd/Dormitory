...
--
-- Host: localhost:3306
-- Generation Time: Mar 14, 2026 at 09:18 AM
...
CREATE TABLE `billing` (
  ...
  `utility_fee` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '',
  `utility_amount` decimal(10,2) DEFAULT '0.00',
  `add_charges` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '',
  ...
  `status` enum('Pending','Unpaid','Partial','Settled','Paid') COLLATE utf8mb4_general_ci DEFAULT 'Pending',
...
(498, 178, 27, NULL, 0.00, NULL, '2026-03-12', 500.00, '', 0.00, '', 0.00, 0.00, 0.00, 100.00, 0.00, 50.00, 'Settled', 'GCash', 450.00, '2026-03-14', 400.00, 0.00, 0.00, '2025-12-10 18:25:24'),
...
CREATE TABLE `billing_sms_status` (
  `bill_id` int NOT NULL,
  `tenant_id` int NOT NULL,
  `last_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `last_message` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `notifications` (
  `id` int NOT NULL,
  `tenant_id` int NOT NULL,
  `type` enum('reminder','confirmation') COLLATE utf8mb4_general_ci NOT NULL,
...
(41, 178, 'confirmation', 'Payment confirmation sent for Room 01. Paid: ₱450.00, Total Bill: ₱400.00', 0, '2026-03-14 03:39:01');
...
CREATE TABLE `rooms` (
  ...
  `room_type` enum('Bed Spacer','Whole Room') COLLATE utf8mb4_general_ci NOT NULL,
  `deck_type` enum('Upper','Lower') COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `record_status` enum('Active','Inactive') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Active'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(35, '03', 'Bed Spacer', NULL, 500.00, 4, 2, 'Available', 2, 2, '2025-10-08 12:21:18', 'Active'),
...
CREATE TABLE `settings` (
  `id` int NOT NULL,
  `setting_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `sms_logs` (
  ...
  `recipient_type` enum('Tenant','Parent','Guardian') COLLATE utf8mb4_general_ci DEFAULT 'Tenant',
  `contact_number` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `message` text COLLATE utf8mb4_general_ci,
  `status` enum('sent','failed','pending','disabled') COLLATE utf8mb4_general_ci DEFAULT 'pending',
...
(81, 178, 'Tenant', '639497428155', 'Ben and Sof Dormitory\nPurok 1A, Mati, San Miguel, ZDS\n\nPayment Confirmation\n\nHi Charity Subiza,\nPayment received for Room 01.\nPayment Date: Mar 14, 2026\nAmount Paid: PHP 450.00\nMethod: GCash\nStatus: Settled\n\nBreakdown:\n- Base Rent: PHP 500.00\n- Interest: PHP 0.00\n- Utilities: None\n- Additional Charges: None\n\nTotal Bill: PHP 400.00\nRemaining Balance: PHP 0.00\nThank you for your payment!', 'sent', 'Success', NULL, 200, '2026-03-14 11:38:59'),
(82, 178, 'Guardian', '639497428155', 'Ben and Sof Dormitory\nPurok 1A, Mati, San Miguel, ZDS\n\nPayment Confirmation\n\nHi Charity Subiza,\nPayment received for Room 01.\nPayment Date: Mar 14, 2026\nAmount Paid: PHP 450.00\nMethod: GCash\nStatus: Settled\n\nBreakdown:\n- Base Rent: PHP 500.00\n- Interest: PHP 0.00\n- Utilities: None\n- Additional Charges: None\n\nTotal Bill: PHP 400.00\nRemaining Balance: PHP 0.00\nThank you for your payment!', 'sent', 'Success', NULL, 200, '2026-03-14 11:39:01');
...
CREATE TABLE `tenants` (
  `tenant_id` int NOT NULL,
  `tenant_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `profile_pic` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `proof_pic` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `room_id` int DEFAULT NULL,
  `deck_type` enum('Lower Deck','Upper Deck') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(186, 'Angel Ravelo', 'uploads/tenant_profile_f86b2cc2358212d774826fc6b3d635d8.jpg', 'uploads/tenant_proof_79f522871599b4aa1f562b032ba7c544.jpg', NULL, NULL, 'Pagadian City Zamboanga Del Sur', '09497428155', '09497428155', 'Active', '2026-03-15', '2026-03-14 13:52:05');
...
(26, 186, 35, 'Lower Deck', '2026-03-14 13:52:05', NULL);
...
--
ALTER TABLE `billing`
  MODIFY `bill_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=522;
...
--
ALTER TABLE `rooms`
  MODIFY `room_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `sms_logs`
  MODIFY `sms_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT for table `tenants`
--
ALTER TABLE `tenants`
  MODIFY `tenant_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;

--
-- AUTO_INCREMENT for table `tenant_rooms`
--
ALTER TABLE `tenant_rooms`
  MODIFY `tenant_room_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
