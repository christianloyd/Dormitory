...
while ($row = $res->fetch_assoc()) {
    ...
    if ($status === "Partial") {
        ...
        // Add to total partial payments
        $totalPartialPayments += $payment_amount;
    }
}
?>
...
.partial-table-container { overflow-x:auto; max-height:70vh; }
...
.total-partial { font-weight:bold; color:#5A7D7C; font-size:16px; margin-top:10px; text-align:right; }
...
<p class="total-partial">Total Partial Payments Collected: ₱<?= number_format($totalPartialPayments, 2); ?></p>
