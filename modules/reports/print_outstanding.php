...
<title>Print - Outstanding Balance Report</title>
<style>
...
<div class="print-header">
    ...
    <div>
        <h1 class="ph-title">Outstanding Balance Report</h1>
...
if (!empty($rows)) {
    ...
    echo '<tr><td colspan="8" style="text-align:center;color:#555;">No tenants with partial payments found.</td></tr>';
}
?>
    </tbody>
</table>
